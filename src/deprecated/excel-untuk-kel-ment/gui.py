...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Set window title
        self.setWindowTitle("KU2062 Agama dan Etika Protestan - Excel-Gen-Kelompok")
    ...
    def run_script(self):
        ...
        # Load data
        self.console.append(f"Loading data from {len(files)} files...")
        db = []
        ...
        # Process
        self.console.append(f"Processing data...")
